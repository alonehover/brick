...
class Background extends React.Component {
    ...
    filterImageShow = backgroundImage => {
        if(backgroundImage) {
            // eslint-disable-next-line no-useless-escape
            return backgroundImage.match(/url\((\S*[^\)])\)/)[1];
        }
    }
        ...
        return(
            <div >
                    ...
                    <Row gutter={16}>
                        ...
                        <Col span={12}>
                            <Input.Group compact>
                                ...
                                <Input style={{width: "60%"}} size="small" readOnly onClick={this.showModal} value={this.filterImageShow(style.backgroundImage)} />
                            </Input.Group>
                        </Col>
                    </Row>
                </Input.Group>
                <Input.Group compact style={{ marginBottom: 16 }}>
                    ...
                    <div style={{height: 24, width: "30%", padding: 5, border: "1px solid #e4e4e4", borderLeftColor: "transparent"}}>
                        <div style={{padding: "5px", border: "1px solid #e4e4e4"}} />
                    </div>
                </Input.Group>
                <Modal
                    title="Image Upload"
                    ...
                    footer={null}
                >
                    <Dragger {...props} disabled={this.state.uploadForbidden} onChange={info => this.uploadChange(info)}>
